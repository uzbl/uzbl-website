...
<div id="left">
  <div id="about">
    ...
    <p>very minimal graphical interface. You only see what you need</p>
    <p>what is not browsing, is not in uzbl.  Things like url changing, loading/saving of bookmarks, saving history, downloads, ... are handled through <b>external</b> scripts that you write</p>
    <p>controllable through various means such as fifo and socket files, stdin, keyboard and more</p>
    <p>advanced, customizable keyboard interface with support for modes, modkeys, multichars, keywords, variable expansion etc. (if you don't understand this: it means you can tweak the interface to be vim-like, emacs-like or any-other-program-like)</p>
